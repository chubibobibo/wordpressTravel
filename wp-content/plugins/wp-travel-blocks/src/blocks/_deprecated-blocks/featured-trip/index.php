 ...
 */
function wptravel_blocks_register_featured_trip_block() {
	// Return early if this function does not exist.
	if ( ! function_exists( 'register_block_type' ) ) {
		return;
	}
	ob_start();
	include WPTRAVEL_BLOCKS_PLUGIN_DIR . 'src/blocks/_deprecated-blocks/featured-trip/block.json';
	$metadata   = json_decode( ob_get_clean(), true );
	$attributes = $metadata['attributes'];
	register_block_type(
		'wp-travel/featured-trip',
		array(
...
add_action( 'init', 'wptravel_blocks_register_featured_trip_block' );
