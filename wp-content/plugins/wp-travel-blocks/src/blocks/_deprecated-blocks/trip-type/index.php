 ...
 */
function wptravel_blocks_register_trip_type_block() {
	// Return early if this function does not exist.
	if ( ! function_exists( 'register_block_type' ) ) {
		return;
	}
	ob_start();
	include WPTRAVEL_BLOCKS_PLUGIN_DIR . 'src/blocks/_deprecated-blocks/trip-type/block.json';
...
add_action( 'init', 'wptravel_blocks_register_trip_type_block' );
